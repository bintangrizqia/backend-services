...
ALTER TYPE "Permission" ADD VALUE 'CAN_CREATE_USER';
ALTER TYPE "Permission" ADD VALUE 'CAN_DELETE_USER';
ALTER TYPE "Permission" ADD VALUE 'CAN_UPDATE_USER';
ALTER TYPE "Permission" ADD VALUE 'CAN_READ_USER';
